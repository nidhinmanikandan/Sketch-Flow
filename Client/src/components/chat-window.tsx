...
const ChatWindow: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      {/* Header */}
      <div
        className={`px-4 py-3 border-b shrink-0 ${isDark ? "dark:border-[#303030]" : "bg-gray-100"}`}
      >
      ...
      {/* Input */}
      <div
        className={`p-3 border-t flex items-center gap-2 shrink-0 ${isDark ? "dark:border-[#303030]" : "bg-gray-100"}`}
      >
        <button
